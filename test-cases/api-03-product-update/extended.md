...
- **__ case** (đề đòi ≥5/API), cột `Nguồn` = **SV**, ID từ `TC-PRODUPD-101`.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| TC-PRODUPD-101 | | | `PUT /api/products/:id` | | | | | | SV | | |
...
|---|---|---|---|
| TC-PRODUPD-101 | | prompt quality / model limitations / characteristics of the API | |
